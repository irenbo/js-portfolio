...
// Функция поиска в строке указанной подстроки и замена ее на новую. 
...
//Вводится строка, содержащая буквы, целые неотрицательные числа 
//и иные символы. Функция реализует следующее: 
//все числа, которые встречаются в строке, помещаются в отдельный целочисленный массив.
...
//Введенные слова сортируются по алфавиту.
